...
public class PQTree
{
  ...
  PQNode root;
  Vector leaves = null; // the leaf PQNodes of the PQTree
  Queue queue = null; // nodes currently being processed by reduction
  Queue clearQueue = null; // nodes to clear after a reduction.
  private int drawWidth;
  private int drawHeight;
  boolean hasChanged;
  String templateMatchString;
  String templateTimeString;
  String reduceString;
  boolean doneReduction;
  boolean cleared;
  Vector constraints = null;
  boolean flaggedAsNull;
  PQNode lastPertRoot = null;
  ...
  {
    PQTreeLifecycleSupport.init(this, initLeaves);
  }
  ...
  {
    PQTreeLifecycleSupport.resetTree(this);
  }
  ...
  {
    PQTreeLifecycleSupport.reductionByValue(this, data);
  }
  ...
  {
    PQTreeLifecycleSupport.clear(this);
  }

  public void clear( Queue queueToClear ) throws Exception
  {
    PQTreeLifecycleSupport.clear(this, queueToClear);
  }
  ...
  {
    PQTreeDebugSupport.printFrontier(this);
  }

  // Prints a preorder traversal of the PQTree to the console.
  public void printTree() throws Exception
  {
    PQTreeDebugSupport.printTree(this);
  }
  ...
  {
    PQTreeDebugSupport.prepareToDrawTree(this);
  }

  void setDrawWidth(int value) { drawWidth = value; }
  void setDrawHeight(int value) { drawHeight = value; }
  boolean hasChangedForDrawing() { return hasChanged; }

  public int getNumNodes() throws Exception
  {
    return PQTreeDebugSupport.getNumNodes(this);
  }

  public int getNumDeletedNodes() throws Exception
  {
    return PQTreeDebugSupport.getNumDeletedNodes(this);
  }
}